...
export class Demo extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      audioSource: null,
      speakerLabels: true,
      keywords: this.getKeywords('en-GB_NarrowbandModel'),
    ...
    this.handleFullUploadClick = this.handleFullUploadClick.bind(this);
  ...
  handleUserFile(files) {
    ...
    if(this.state.full == false){this.playFile(file);}else{this.fullFile(file)}
  }
      ...
      >
        ...
        <div className="flex buttons">
          ...
          <button type="button" className={buttonClass} onClick={this.handleUploadClick}>
            <Icon type={audioSource === 'upload' ? 'stop' : 'upload'} /> Upload Audio File- Transcribe Live
          </button>

          <button type="button" className={buttonClass} onClick={this.handleFullUploadClick}>
            <Icon type={audioSource === 'upload' ? 'stop' : 'upload'} /> Upload Audio File- Transcribe Once
          </button>
